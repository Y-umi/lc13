/obj/item/clothing/suit/armor/ego_gear/city/cinq
	name = "cinq association duelist gear"
...
/obj/item/clothing/suit/armor/ego_gear/city/cinqwest
	...
	desc = "A black and blue suit used by the fixers of cinq association."
	icon_state = "cinqwest"
	armor = list(RED_DAMAGE = 40, WHITE_DAMAGE = 30, BLACK_DAMAGE = 40, PALE_DAMAGE = 0)
	...
	hat = /obj/item/clothing/head/ego_hat/cinqwest
	neck = /obj/item/clothing/neck/ego_neck/cinqwest
