GLOBAL_LIST_INIT(l2esquads, list("Axe", "Buckler", "Cleaver"))

//These are proper agents for W-Corp, and not the chaff you're familiar with. - Angela
/datum/job/wcorpheavy
	title = "W-Corp L2 Type E Heavy Armor Specialist"
	faction = "Station"
	...
	outfit = /datum/outfit/job/wcorpheavy
	display_order = 4.9
...
/datum/job/wcorpheavy/after_spawn(mob/living/carbon/human/outfit_owner, mob/M)
	ADD_TRAIT(outfit_owner, TRAIT_COMBATFEAR_IMMUNE, JOB_TRAIT)
	var/squad = pick_n_take(GLOB.l2esquads)
	.=..()
	var/ears = null
...
//Outfits
/datum/outfit/job/wcorpheavy
	name = "W-Corp L2 Type E Heavy Armor Specialist"
	jobtype = /datum/job/wcorpheavy
	...
	suit = /obj/item/clothing/suit/armor/ego_gear/wcorp/heavy/noreq
	l_pocket = /obj/item/flashlight/seclite

	backpack_contents = list(/obj/item/storage/box/pcorp)

/datum/outfit/job/wcorpheavy/post_equip(mob/living/carbon/human/outfit_owner, visualsOnly = FALSE)
	..()
	var/belt = pick(
