...
/datum/ego_datum/armor/New(datum/abnormality/DA)
	...
	information["armor"][RED_DAMAGE] = armor_to_protection_class(red_armor)
	information["armor"][WHITE_DAMAGE] = armor_to_protection_class(white_armor)
	information["armor"][BLACK_DAMAGE] = armor_to_protection_class(black_armor)
	information["armor"][PALE_DAMAGE] = armor_to_protection_class(pale_armor)
	information["attribute_requirements"] = E.attribute_requirements.Copy()
	qdel(E)
